---
name: plantuml-ascii
description: "Generate ASCII art diagrams using PlantUML text mode. Use when user asks to create ASCII diagrams, text-based diagrams, terminal-friendly diagrams, architecture diagrams in ASCII format, or mentions plantuml ascii, text diagram, ascii art diagram, architecture diagram. Supports: Converting PlantUML diagrams to ASCII art, Creating sequence diagrams, class diagrams, flowcharts, architecture diagrams in ASCII format, Generating Unicode-enhanced ASCII art with -utxt flag"
license: MIT
